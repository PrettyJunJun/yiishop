    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl cat1"> <!-- 非首页，需要添加cat1类 -->
            <div class="cat_hd off">
                <!-- 注意，首页在此div上只需要添加cat_hd类，非首页，默认收缩分类时添加上off类，并将cat_bd设置为不显示，鼠标滑过时展开菜单则将off类换成on类 -->
                <h2>全部商品分类</h2>
                <em></em>
            </div>
            ...
            <ul>
                <?php foreach ($goods as $row): ?>
                    <li>
                        <dl>
                            <dt>
                                <a href="<?= \yii\helpers\Url::to(['goods-list/good-display', 'id' => $row->id]) ?>"><img
                                            src="<?= $row->logo ?>" alt=""/></a></dt>
                            <dd>
                                <a href="<?= \yii\helpers\Url::to(['goods-list/good-display', 'id' => $row->id]) ?>"><?= $row->name ?></a>
                            </dt>
                            <dd><strong><?= $row->shop_price ?></strong>
                            </dt>
