...
<div class="header w1210 bc mt15">
    ...
    <div class="logo w1210">
        <h1 class="fl"><a href="index.html"><img width="200px" src="/images/jd.png" alt="京西商城"></a></h1>
        <!-- 头部搜索 start -->
        <div class="search fl">
                ...
                <ul>
                    ...
                    <li>
                        <dl>
                            ...
                            <dd><a href="">ThinkPad X230i(2306-3V9） 12.5英寸笔记本电脑 （i3-3120M 4GB 500GB 7200转 蓝牙 摄像头
                                    Win8）</a></dd>
                            <dd><strong>￥5199.00</strong></dd>
                        </dl>
                    </li>
                    ...
                    <li>
                        <dl>
                            ...
                            <dd><a href="">T联想（Lenovo） Yoga13 II-Pro 13.3英寸超极本 （i5-4200U 4G 128G固态硬盘 摄像头 蓝牙 Win8）晧月银</a>
                            </dd>
                    ...
                    <li class="last">
                        <dl>
                            ...
                            <dd><a href="">ThinkPad E530c(33662D0) 15.6英寸笔记本电脑 （i5-3210M 4G 500G NV610M 1G独显 摄像头
                                    Win8）</a></dd>
        ...
        <div class="summary">
                        ...
                        <ul>
                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);"
                                   rel="{gallery: 'gal1', smallimage: '<?= $row->logo ?>',largeimage: '<?= $row->logo ?>'}"><img
                                            src="<?= $row->logo ?>"></a>
                            </li>
                            <?php foreach ($gallerys as $value): ?>
                                <li>
                                    <a href="javascript:void(0);"
                                       rel="{gallery: 'gal1', smallimage: '<?= $value->path ?>',largeimage: '<?= $value->path ?>'}">
                                        <img src="<?= $value->path ?>"></a>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li class="shop_price"><span>本店价：</span> <strong>￥<?= $row->shop_price ?></strong> <a
                                href="">(降价通知)</a></li>
        ...
        <div class="detail">
            ...
            <div class="detail_bd">
                ...
                <div class="after_sale mt15 none detail_div">
                    <div>
                        <p>本产品全国联保，享受三包服务，质保期为：一年质保 <br/>如因质量问题或故障，凭厂商维修中心或特约维修点的质量检测证明，享受7日内退货，15日内换货，15日以上在质保期内享受免费保修等三包服务！
                        </p>
                    ...
                    <div>
                        <h3>服务承诺：</h3>
                        <p>
                            本商城向您保证所售商品均为正品行货，京东自营商品自带机打发票，与商品一起寄送。凭质保证书及京东商城发票，可享受全国联保服务（奢侈品、钟表除外；奢侈品、钟表由本商城联系保修，享受法定三包售后服务），与您亲临商场选购的商品享受相同的质量保证。本商城还为您提供具有竞争力的商品价格和运费政策，请您放心购买！</p>
