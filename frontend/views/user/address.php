    ...
    <div class="menu fl">
        ...
        <div class="menu_wrap">
            ...
            <dl>
                ...
                <dd><b>.</b><a href="<?=\yii\helpers\Url::to(['user/address'])?>">收货地址</a></dd>
            </dl>
    ...
    <div class="content fl ml10">
        <div class="address_hd">
            ...
            <?php foreach($addresses as $address):?>
                <dl>
                    <dt>1.<?=$address->name?> <?=$address->province?> <?=$address->city?> <?=$address->area?> <?=$address->detail_address?> <?=$address->phone?> </dt>
                    <dd>
                        <a href="">修改</a>
                        <a href="">删除</a>
                        <a href="">设为默认地址</a>
...
<li>
    <label for="">&nbsp;</label>
    <input type="submit" id="submit" name="" class="btn" value="保存"/>
</li>
</ul>
</form>
</div>
