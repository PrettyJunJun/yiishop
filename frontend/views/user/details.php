        ...
        <div class="order_bd mt10">
            <table class="orders">
                ...
                <?php foreach ($models as $model): ?>
                    <?php $time = \frontend\models\Order::findOne(['id' => $model->order_id]); ?>
                    <tr>
                        <td><a href=""><?= $model->id ?></a></td>
                        <td><a href=""><?php if ($model->amount > 3) {
                                    $model->amount = 3;
                                };
                        ...
                        <td><?= $time['name'] ?></td>
                        <td>￥<?= $model->price ?> <?= $time['payment_name'] ?></td>
                        <td><?= date('Y-m-d H:i:s', $time['create_time']) ?></td>
                        <td><?php if ($time['status'] === 0) {
                                echo '已取消';
