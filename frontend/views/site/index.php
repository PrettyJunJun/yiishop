...
<div class="header w1210 bc mt15">
    ...
    <div class="logo w1210">
        <h1 class="fl"><a href="index.html"><img width="250px" height="100px" src="/images/jd.png" alt="京西商城"></a></h1>
        <!-- 头部搜索 start -->
        <div class="search fl">
        ...
        <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd">
                <?php foreach ($parent_id as $parent): ?>
                    <div class="cat item1">
                        <h3>
                            <a href="<?= \yii\helpers\Url::to(['goods-list/index', 'id' => $parent->id]) ?>"><?= $parent->name ?></a>
                            <b></b></h3>

                        <div class="cat_detail">
                            <?php foreach ($rows[$parent->id] as $good): ?>
                                <dl class="dl_1st">
                                    <dt>
                                        <a href="<?= \yii\helpers\Url::to(['goods-list/index', 'id' => $good->id]) ?>"><?= $good->name ?></a>
                                    </dt>
                                    <?php foreach ($Categorys[$good->id] as $row): ?>
                                        <dd>
                                            <a href="<?= \yii\helpers\Url::to(['goods-list/index', 'id' => $row->id]) ?>"><?= $row->name ?></a>
                                        </dd>
                                    <?php endforeach; ?>
                                </dl>
                            <?php endforeach; ?>
